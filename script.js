...
function updatePageNumbersDisplay(pages, pageHeightPixels) {
    ...
    // Start numbering from page 2 (since page 1 is the Title Page)
...
// Char Sheet Help Logic
const btnCharSheetHelp = document.getElementById('btn-char-sheet-help');
const charSheetHelpModal = document.getElementById('char-sheet-help-modal');
const btnCloseCharHelp = document.getElementById('btn-close-char-help');

if (btnCharSheetHelp && charSheetHelpModal) {
    btnCharSheetHelp.addEventListener('click', () => {
        charSheetHelpModal.style.display = charSheetHelpModal.style.display === 'none' ? 'block' : 'none';
    });
}
if (btnCloseCharHelp && charSheetHelpModal) {
    btnCloseCharHelp.addEventListener('click', () => {
